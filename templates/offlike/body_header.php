...
<style>  
.modern-header {
  background: linear-gradient(to right, #1a0f00, #000);
  color: #ffcc66;
  font-weight: bold;
  font-size: 20px;
  padding: 8px 16px;
...
.realm-select-form select:focus {
  outline: none;
  border-color: #ffcc00;
}
...
.account-dropdown .menu-realm-label {
  font-weight: bold;
  color: #ffdd77;
...
.account-dropdown .char-item.active-char {
  color: #ffcc00;
  font-weight: bold;
  background: rgba(255,255,255,0.07);
}
.account-dropdown .menu-spacer {
  margin: 6px 0;
  border-top: 1px solid rgba(255,255,255,0.07);
}
...
.account-dropdown .account-menu {
  ...
  background: #111 url('../images/subnav/bg.gif') repeat-y;
  border: 1px solid #444;
  border-radius: 6px;
...
.account-dropdown .account-menu a[href*="manage"]::before { content: "\f013"; }
.account-dropdown .account-menu a[href*="pms"]::before { content: "\f0e0"; }
.account-dropdown .account-menu a[href*="logout"]::before { content: "\f2f5"; }
...
.account-dropdown .class-1  { color: #C79C6E; } /* Warrior */
.account-dropdown .class-2  { color: #F58CBA; } /* Paladin */
.account-dropdown .class-3  { color: #ABD473; } /* Hunter */
.account-dropdown .class-4  { color: #FFF569; } /* Rogue */
.account-dropdown .class-5  { color: #FFFFFF; } /* Priest */
.account-dropdown .class-6  { color: #C41E3A; } /* Death Knight */
.account-dropdown .class-7  { color: #0070DE; } /* Shaman */
.account-dropdown .class-8  { color: #69CCF0; } /* Mage */
.account-dropdown .class-9  { color: #9482C9; } /* Warlock */
.account-dropdown .class-11 { color: #FF7D0A; } /* Druid */

.account-dropdown .char-item:hover span {
  filter: brightness(1.3);
  text-shadow: 0 0 6px rgba(255,255,255,0.4);

}

/* Adjust level label color */
.account-dropdown .char-item .level {
  color: #999;
  font-size: 12px;
  margin-left: 4px;
}
