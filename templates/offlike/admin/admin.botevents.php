...
<div class="sections subsections" style="font-size:.85em;">
  ...
  <div class="bot-card" style="margin-bottom:12px;">
    ...
    <?php if ($botCommand !== ''): ?><div class="bot-output" id="bot-command-box" style="max-height:none;color:#dbe9ff;"><?php echo htmlspecialchars($botCommand); ?></div><p><button type="button" class="bot-save" onclick="copyBotCommand()">Copy</button></p><?php endif; ?>
  </div>
  <?php endif; ?>
