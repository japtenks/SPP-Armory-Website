...
<li><div>
<?php echo $lang['si_on']; ?>:&nbsp;<b><?php echo $server['realplayersonline']; ?></b>
</div></li>
...
<li><div>
<?php echo $lang['si_acc']; ?>:&nbsp;<b><?php echo $server['accounts']; ?><?php if (isset($server['active_accounts'])): ?> <?php echo sprintf($lang['si_active_total'], $server['active_accounts'], $server['active_login']); ?><?php endif; ?></b>
</div></li>
