...
<?php foreach($items as $item): ?>
        <tr>
            ...
            <td class="serverStatus<?php echo $item['res_color'] ?>" align="center"><b style='color: rgb(35, 67, 3);'><?php if($item['uptime'] != 0) { if ($item['id'] == 1) {echo $item['pop']." (".population_view($item['pop']).")";} else { echo population_view($item['pop']); }} ?></b></td>
        </tr>
<?php endforeach; ?>
        </tbody>
    </table>
