...
<?php builddiv_start(1, $lang['worldsets']); ?>
<div class="modern-content">
  <img src="<?php echo $currtmp; ?>/images/armorsets.jpg" alt="world sets" class="ah-banner"/>
...
foreach ($classes as $c){
  $href   = 'index.php?n=server&sub=worldsets&class='.rawurlencode($c['name']).$styleQS;
...
foreach ($order as $key) {
  ...
  echo "<div class='set-desc'>".htmlspecialchars($text)."</div>";
