...
require_once(__DIR__ . '/../../../core/common.php');   // optional helper set

/* ---------------------------------------------------------
   Armor & Dungeon Sets - Standalone Version
   Self-contained like server.ah.php (no external includes)
----------------------------------------------------------*/

global $DB, $CHDB, $WSDB, $realmId, $realmName;
...
function dbErrorHandler($message, $info) {
    ...
    // otherwise, stay silent in normal mode
}
...
/* ---------- Armory and world query helpers ---------- */
