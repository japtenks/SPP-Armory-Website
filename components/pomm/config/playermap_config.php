...
if (file_exists("../../vmangos.spp")) {
	$realm_db['addr']     = '127.0.0.1:3306';
	$realm_db['name']     = 'tw_logon';
	$realm_db['pass']     = 'root';
	$realm_db['user']     = 'root';
}
...
$world_db[4]['addr']          = '127.0.0.1:3306'; // SQL server IP:port this DB located on
$world_db[4]['user']          = 'root';           // SQL server login this DB located on
$world_db[4]['pass']          = 'root';              // SQL server pass this DB located on
$world_db[4]['name']          = 'tw_world';         // World Database name, by default "mangos" for MaNGOS, "world" for Trinity
$world_db[4]['encoding']      = 'utf8';           // SQL connection encoding
...
$characters_db[4]['addr']     = '127.0.0.1:3306'; // SQL server IP:port this DB located on
$characters_db[4]['user']     = 'root';           // SQL server login this DB located on
$characters_db[4]['pass']     = 'root';              // SQL server pass this DB located on
$characters_db[4]['name']     = 'tw_char_ptr';     // Character Database name
$characters_db[4]['encoding'] = 'utf8';           // SQL connection encoding
...
$server[4]['addr']          = '127.0.0.1'; // Game Server IP, as seen by MiniManager, from your webhost
$server[4]['addr_wan']      = '127.0.0.1'; // Game Server IP, as seen by clients - Must be external address
$server[4]['game_port']     =  8085;       // Game Server port
$server[4]['rev']           = '';     // MaNGOS rev. used (Trinity does not need this)
$server[4]['both_factions'] =  true;       // Allow to see opponent faction characters. Affects only players.
